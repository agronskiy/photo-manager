...
[Setup]
AppName=Photo Manager (editor)
AppVerName=Photo Manager (editor) 1.2.3
AppPublisher=Alex Y. Gronsky
AppVersion=1.2.3
OutputBaseFilename=photomanager-1.2.3-editor-setup
OutputDir="..\1.2.arch"

DefaultDirName={pf}\Photo Manager (editor)
DefaultGroupName=Photo Manager (editor)

InfoBeforeFile=textbefore.txt

[Icons]
Name: "{group}\Photo Manager (editor) 1.2.3"; Filename: "{app}\PhotoCatalog.exe"; WorkingDir: "{app}"
